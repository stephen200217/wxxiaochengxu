Page({
  ...
  getWeather(city) {
    ...
    //获取实况天气
    wx.request({
      url: 'https://free-api.heweather.net/s6/weather/now?key=cf33e62e9f674e19b8e2011db8217c48&location=' + city,
      success: function(res) {
        ...
        //获取24小时天气预报
        wx.request({
          url: 'https://free-api.heweather.net/s6/weather/hourly?key=cf33e62e9f674e19b8e2011db8217c48&location=' + city,
          success: function(res) {
            ...
            //获取未来7天天气预报
            wx.request({
              url: 'https://free-api.heweather.net/s6/weather/forecast?key=cf33e62e9f674e19b8e2011db8217c48&location=' + city,
